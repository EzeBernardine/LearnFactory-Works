...
// if(prompt("input your password number")=="2019"){
//       alert("correct account number");
//        if(prompt("input your drawer code") =="0012"){
//             alert("you have won $20,000,000,000");
//             alert("Miss Bernar, thank you for your effort");
//       }else{
//             alert("you dont have an active account");
//       }
